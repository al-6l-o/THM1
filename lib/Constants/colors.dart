...
class AppColors {
  // ألوان الوضع الفاتح
  static const Color primaryColor = Color.fromARGB(255, 0, 131, 105);
  static const Color secondaryColor = Color.fromARGB(255, 2, 172, 170);
  static const Color backgroundColor = Color(0xFFFFFFFF);
  static const Color textColor = Color(0xFF000000);
  static const Color warningColor = Color.fromARGB(255, 148, 0, 0);
  static const Color AlertDialogColor = Color.fromARGB(255, 217, 217, 217);
